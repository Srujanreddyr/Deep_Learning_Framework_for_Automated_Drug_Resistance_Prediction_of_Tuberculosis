...
urlpatterns = [
    ...
    path("ConventionalTraining/", usr.ConventionalTraining, name="ConventionalTraining"),
    path("TuberculosisTraining/", usr.TuberculosisTraining, name="TuberculosisTraining"),
    path("TestMyModel/", usr.TestMyModel, name="TestMyModel"),
